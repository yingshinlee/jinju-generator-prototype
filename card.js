...
window.QuoteCard = (function () {
  ...
  const STYLES = [
    ...
    {id:'violet', name:'靛紫', sw:'#5b5080', bg:'#514775', quoteColor:'#f4f1fb', accent:'#c3b6e8', sub:'#d6cdee', font:SANS, weight:500, logo:'white', qrDark:'#f4f1fb', qrLight:'#514775'},
    {id:'slate',  name:'霧灰', sw:'#c9cace', bg:'#e7e8ec', quoteColor:'#2b2b2e', accent:'#7f7f88', sub:'#6f6f78', font:SANS, weight:400, qrDark:'#333333', qrLight:'#e7e8ec'},
  ];
